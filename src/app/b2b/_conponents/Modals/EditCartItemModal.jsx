    ...
    <Modal open={open} onClose={onClose} className="max-w-[900px] ">
      ...
      >
        ...
        <div className="mt-6 w-[50%]">
          <label className="labelCls mb-5">Select Active side of the door</label>
        ...
        <div className="mt-6  xl:w-[50%] mb-5">
          <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col w-[60%] gap-y-5 gap-4">
            <div className="flex justify-center items-center gap-4">
              <label className="labelCls mb-0">Width</label>
        ...
        <div className="my-10 grid grid-cols-1 md:grid-cols-3 gap-4">
          <label className="inline-flex text-[20px]  items-center gap-2">
            <input type="checkbox" className="h-6 w-6" {...register("highBottom")} />
            <span>High Bottom</span>
          </label>
          <label className="inline-flex text-[20px]  items-center gap-2">
            <input type="checkbox" className="h-6 w-6" {...register("insulatedGlass")} />
            <span>Insulated Glass</span>
          </label>
          <label className="inline-flex text-[20px]  items-center gap-2">
            <input type="checkbox" className="h-6 w-6" {...register("adaThreshold")} />
        ...
        <div className="my-10 xl:w-[50%] border-2 border-dashed rounded-2xl p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          <div>
            <p className="text-[48px] font-bold">4% OFF</p>
            <p className="text-gray-600 text-[24px]">Ex: 1/02/2026</p>
          </div>
          <div>
            <p className="text-[36px]">Coupon</p>
            <button
              type="button"
              onClick={() => setValue("couponCode", "SAVE4")}
              className="h-11 px-4 rounded-xl bg-[#E91E63] text-white hover:opacity-90 w-full"
            >
              Add Coupon
            </button>
          </div>
        ...
        <div className="my-10 flex w-[80%] gap-3">
          <input
