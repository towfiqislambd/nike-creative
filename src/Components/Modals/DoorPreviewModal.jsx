...
const DoorPreviewModal = ({ onTryOn }) => {
  return (
    <>
      <div className="flex gap-7">
        ...
        <div className="pt-4 pb-7 flex flex-col justify-between">
          ...
          <div className="flex gap-8 items-center">
            ...
            <button
              onClick={onTryOn}
              className="border rounded-lg border-light-green text-light-green cursor-pointer flex gap-2 items-center px-4 py-3 hover:bg-light-green hover:text-white duration-300 transition-all"
            >
              <TrySvg />
              <span>Try On</span>
            </button>
